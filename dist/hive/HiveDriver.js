...
class HiveDriver {
    ...
    openSession(request) {
        const action = new OpenSessionCommand_1.default(this.client);
        return action.execute(request);
    }
    closeSession(request) {
        const command = new CloseSessionCommand_1.default(this.client);
        return command.execute(request);
    }
    executeStatement(request) {
        const command = new ExecuteStatementCommand_1.default(this.client);
        return command.execute(request);
    }
    getResultSetMetadata(request) {
        const command = new GetResultSetMetadataCommand_1.default(this.client);
        return command.execute(request);
    }
    fetchResults(request) {
        const command = new FetchResultsCommand_1.default(this.client);
        return command.execute(request);
    }
    getInfo(request) {
        const command = new GetInfoCommand_1.default(this.client);
        return command.execute(request);
    }
    getTypeInfo(request) {
        const command = new GetTypeInfoCommand_1.default(this.client);
        return command.execute(request);
    }
    getCatalogs(request) {
        const command = new GetCatalogsCommand_1.default(this.client);
        return command.execute(request);
    }
    getSchemas(request) {
        const command = new GetSchemasCommand_1.default(this.client);
        return command.execute(request);
    }
    getTables(request) {
        const command = new GetTablesCommand_1.default(this.client);
        return command.execute(request);
    }
    getTableTypes(request) {
        const command = new GetTableTypesCommand_1.default(this.client);
        return command.execute(request);
    }
    getColumns(request) {
        const command = new GetColumnsCommand_1.default(this.client);
        return command.execute(request);
    }
    getFunctions(request) {
        const command = new GetFunctionsCommand_1.default(this.client);
        return command.execute(request);
    }
    getPrimaryKeys(request) {
        const command = new GetPrimaryKeysCommand_1.default(this.client);
        return command.execute(request);
    }
    getCrossReference(request) {
        const command = new GetCrossReferenceCommand_1.default(this.client);
        return command.execute(request);
    }
    getOperationStatus(request) {
        const command = new GetOperationStatusCommand_1.default(this.client);
        return command.execute(request);
    }
    cancelOperation(request) {
        const command = new CancelOperationCommand_1.default(this.client);
        return command.execute(request);
    }
    closeOperation(request) {
        const command = new CloseOperationCommand_1.default(this.client);
        return command.execute(request);
    }
    getDelegationToken(request) {
        const command = new GetDelegationTokenCommand_1.default(this.client);
        return command.execute(request);
    }
    cancelDelegationToken(request) {
        const command = new CancelDelegationTokenCommand_1.default(this.client);
        return command.execute(request);
    }
    renewDelegationToken(request) {
        const command = new RenewDelegationTokenCommand_1.default(this.client);
        return command.execute(request);
    }
}
